...
<div id="page-wrap">
  ...
  <div v-if="submitted && !placed">
    ...
    <form @submit.prevent="placeOrder">
        ...
        <div class="radio">
      <input type="radio" id="payment" v-model="formData.payment" value="cod"/>Cash On Delivery <br />
      <input type="radio" id="payment" v-model="formData.payment" value="card"/>Via Debit/Credit Card
        </div>
...
import axios from 'axios';
    export default {
            ...
            placeOrder(){
                ...
                .then(res => {
                    if(res.data.orderSuccessful){
                        ...
                        axios.delete(`http://localhost:5000/${user_id}/emptyCart`)
                        .then(res => {
        ...
        mounted(){
            ...
            console.log(this.$route.query.totalPrice, this.$route.query.orderItems);
        }
    }
</script>
